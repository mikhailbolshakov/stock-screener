package com.mikhailb.stockscreener.notification.consumer;
...
public class UserAccountConsumer {
    private final Logger logger = LoggerFactory.getLogger(UserAccountConsumer.class);

    @KafkaListener(topics = {"user-account"})
